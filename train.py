...
parser.add_argument(
    '-c',
    '--checkpoint',
    default='cifar10_Imagenet_checkpoint',
    type=str,
    metavar='PATH',
...
class MySolver(Solver):
    ...
    def set_dataloater(self):
        if args.in_dataset == 'cifar10':
            ...
            semi_train_dataset = CIFAR10Mix(
                'data',
                f"./data/{args.out_dataset}",
                train=False,
                val=False,
                download=True,
                transform=transforms.Compose([
            ...
            semi_train_dataset = CIFAR100Mix(
                'data',
                f"./data/{args.out_dataset}",
                train=False,
                val=False,
        ...
        self.semi_train_loader = torch.utils.data.DataLoader(
            semi_train_dataset,
            batch_size=args.batch_size,
            shuffle=True,
            num_workers=0)
